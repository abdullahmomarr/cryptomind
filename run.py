...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_seed.add_argument("--engine", choices=["rule", "groq", "openrouter", "claude", "llm"], default="rule",
    ...
    p_live.add_argument("--engine", choices=["rule", "groq", "openrouter", "claude", "llm"], default="rule",
                        help="Reasoning engine (default: rule; 'openrouter' = free LLM, 'claude' = paid).")
    ...
    p_eval.add_argument("--engine", choices=["rule", "groq", "openrouter", "claude", "llm"], default="rule",
